...
│   │   │   ├── metadata.json
│   │   │   └── README.md
│   │   └── perf-optimize/            # Workflow skill: guided perf optimization (5 stages)
│   │       ├── SKILL.md
│   │       ├── metadata.json
│   │       └── README.md
│   └── clickhouse/                   # ClickHouse skills
│       └── best-practices/           # Reference skill (28 rules + build pipeline)
...
GitHub Actions runs on changes to `skills/clickhouse/` or `packages/`:
